/**
* @fileoverview Esta clase representa tanto logíca, como graficamente un turbo en el juego
*
...
*/
var Turbo = function(){
    //Objetos con los que podra colisionar el turbo, en este caso otra águila
    ...
    */
    this.setModelo=function(objeto, objetoGeometria, objetoMaterial){
        ...
        this.objeto.rotation.x = angulo(10);
        this.reubicar();
    };
    
    /*
    * Cambia la posicion logica X, Y, Z del turbo
    ...
    */
    ...
    /*
    * Cambia la posicion grafica X, Y, Z del turbo
    ...
    * @returns {object} Es un vector con las coordenadas graficas del turbo
    */
    ...
    /*
    * Verifica si el turbo colisionó con un jugador, se reubica el muro, y acelera
    ...
    this.colision=function(){
        for(var i=0;i<this.objetosColision.length;i++){
            if(this.x === this.objetosColision[i].x && this.y === this.objetosColision[i].y && this.z === this.objetosColision[i].z){
                this.objetosColision[i].acelerar();
                this.reubicar();
                Turbo.sonido.reproducir(true);
            }
        }
    };
    
    /*
    * Verifica si el turbo colisionó con un jugador llamando al respectivo metodo,
    * y detecta si el turbo se encuentra muy atras del ultimo jugador y lo reubica.
    */
    this.avanzar=function(){
        this.objeto.rotation.y+= angulo(10);
        this.colision();
    ...
    /*
     * Reubica el turbo mas adelante del primer jugador
     */
...
Turbo.sonido=new KPTF.Sonido("sonido/moneda.mp3");